...
Este projeto apresenta o desenvolvimento do FlashLanche, uma plataforma digital de autoatendimento projetada para otimizar a logística de consumo nas lanchonetes da PUC Minas Contagem. O trabalho surge da necessidade de solucionar o gargalo gerado pelo curto intervalo de 10 minutos, período em que diversos alunos de diferentes cursos enfrentam filas extensas e processos de pagamento manuais, que resultam em atrasos para as aulas seguintes e no comprometimento do intervalo com a espera no atendimento. Através de um sistema de pedidos e pagamentos antecipados, o projeto visa transformar a dinâmica atual que é presencial e manual, em um fluxo ágil de "clicar e retirar". O objetivo é atender tanto o perfil acadêmico, que busca pontualidade, quanto o perfil operacional e de gestão, que necessitam de maior previsibilidade e eficiência no atendimento.
